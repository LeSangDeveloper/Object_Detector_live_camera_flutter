...
class ImageUtils {
  ...
  static imageLib.Image convertBGRA8888ToImage(CameraImage cameraImage) {
    int imageWidth = cameraImage.planes[0].width ?? 0;
    int imageHeight = cameraImage.planes[0].height ?? 0;
    imageLib.Image img = imageLib.Image.fromBytes(imageWidth,
        imageHeight, cameraImage.planes[0].bytes,
